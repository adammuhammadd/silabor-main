...
MySQL - 5.7.33 : Database - db_silabor
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_silabor` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
DROP TABLE IF EXISTS `tb_bidang_lab`;

CREATE TABLE `tb_bidang_lab` (
  `id_bidang_lab` int(11) NOT NULL AUTO_INCREMENT,
  `bidang_lab` varchar(255) NOT NULL,
  `date_created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `date_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id_bidang_lab`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_bidang_lab` */
...
DROP TABLE IF EXISTS `tb_permohonan_bebas_lab`;

CREATE TABLE `tb_permohonan_bebas_lab` (
  `id_permohonan_bebas_lab` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `date_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id_permohonan_bebas_lab`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_permohonan_bebas_lab` */

insert  into `tb_permohonan_bebas_lab`(`id_permohonan_bebas_lab`,`kode_permohonan`,`id_user`,`id_kepala_upt`,`tgl_penerimaan`,`file`,`status`,`status_kepala_upt`,`date_created`,`date_modified`) values 
(1,'PBL-1-030922',100,38,'2022-09-03','zulhalim.png','Diizinkan','Diizinkan','2022-09-03 22:51:41',NULL),
(2,'PBL-2-030922',39,NULL,NULL,'verdi.png','Tidak diizinkan','Tidak diizinkan','2022-09-03 23:20:17',NULL),
(3,'PBL-3-030922',39,NULL,NULL,'verdi1.png','Belum diizinkan','Belum diizinkan','2022-09-03 16:20:50',NULL),
(4,'PBL-4-030922',40,38,'2022-09-03','zulhalim1.png','Diizinkan','Diizinkan','2022-09-04 01:40:33',NULL),
(5,'PBL-5-040922',41,38,'2022-09-04','verdi2.png','Diizinkan','Diizinkan','2022-09-04 22:05:03',NULL);

/*Table structure for table `tb_permohonan_pinjam_alat` */

DROP TABLE IF EXISTS `tb_permohonan_pinjam_alat`;

CREATE TABLE `tb_permohonan_pinjam_alat` (
  `id_permohonan_pinjam_alat` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `date_created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `date_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id_permohonan_pinjam_alat`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `tb_permohonan_pinjam_alat_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_permohonan_pinjam_alat` */
...
(2,'PPA-1-240822',2,43,38,'Diizinkan','Diizinkan','Diizinkan','Telah dikembalikan','2022-09-03','2022-09-03','2022-09-03 10:54:33',NULL),
(10,'PPA-2-030922',39,44,38,'Diizinkan','Diizinkan','Diizinkan','Telah dikembalikan','2022-09-03','2022-09-03','2022-09-03 22:23:13',NULL),
(11,'PPA-3-030922',39,3,38,'Diizinkan','Diizinkan','Diizinkan','Telah dikembalikan','2022-09-03','2022-09-03','2022-09-03 22:40:13',NULL),
(12,'PPA-4-030922',40,43,38,'Diizinkan','Diizinkan','Diizinkan','Telah dikembalikan','2022-09-03','2022-09-03','2022-09-04 00:35:00',NULL),
(13,'PPA-5-040922',41,43,38,'Diizinkan','Diizinkan','Diizinkan','Telah dikembalikan','2022-09-04','2022-09-04','2022-09-04 22:02:13',NULL);
...
CREATE TABLE `tb_pinjam` (
  ...
  KEY `id_permohonan_pinjam_alat` (`id_permohonan_pinjam_alat`),
  CONSTRAINT `tb_pinjam_ibfk_2` FOREIGN KEY (`id_permohonan_pinjam_alat`) REFERENCES `tb_permohonan_pinjam_alat` (`id_permohonan_pinjam_alat`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_pinjam` */

insert  into `tb_pinjam`(`id_pinjam`,`id_alat`,`id_permohonan_pinjam_alat`,`id_bidang_lab`,`jml_alat`,`kondisi_awal`,`kondisi_akhir`,`status`,`date_created`,`date_modified`) values 
(3,2,2,0,1,'Baik','Baik','Telah dikembalikan','2022-09-03 10:54:33',NULL),
(15,3,10,1,1,'Baik','Rusak','Telah dikembalikan','2022-09-03 22:23:13',NULL),
(16,1,11,24,1,'Baik','Baik','Telah dikembalikan','2022-09-03 22:40:13',NULL),
(17,3,12,1,1,'Baik','Baik','Telah dikembalikan','2022-09-04 00:22:47',NULL),
(18,1,12,24,1,'Baik','Baik','Telah dikembalikan','2022-09-04 00:24:43',NULL),
(19,2,12,10,1,'Baik','Baik','Telah dikembalikan','2022-09-04 00:35:00',NULL),
(20,3,13,1,1,'Baik','Baik','Telah dikembalikan','2022-09-04 22:02:13',NULL),
(21,1,13,24,1,'Baik','Baik','Telah dikembalikan','2022-09-04 22:00:43',NULL),
(22,2,13,10,1,'Baik','Baik','Telah dikembalikan','2022-09-04 22:01:02',NULL);
...
(2, 'kepala_upt_lab', 'tarmizi.taher@itera.ac.id', NULL, NULL, '$2y$10$7tD.8AjQr0TgTM0EV1wt.O588GYMJ0UaVgn5eAAXglRge9QkYWJhy', 'Itera', '1990-01-01', 2, 'Laki-laki', 'Kepala UPT Lab', '2022-10-28 11:03:39', NULL),
...
DROP TABLE IF EXISTS `tb_validasi_kalab`;

CREATE TABLE `tb_validasi_kalab` (
  `id_validasi_kalab` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `date_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id_validasi_kalab`),
  KEY `id_permohonan_bebas_lab` (`id_permohonan_bebas_lab`),
  CONSTRAINT `tb_validasi_kalab_ibfk_1` FOREIGN KEY (`id_permohonan_bebas_lab`) REFERENCES `tb_permohonan_bebas_lab` (`id_permohonan_bebas_lab`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_validasi_kalab` */

insert  into `tb_validasi_kalab`(`id_validasi_kalab`,`id_permohonan_bebas_lab`,`id_kalab`,`status_validasi`,`date_created`,`date_modified`) values 
(1,4,5,'Diizinkan','2022-09-03 17:41:08',NULL),
(2,3,28,'Diizinkan','2022-09-03 17:41:20',NULL),
(3,3,5,'Diizinkan','2022-09-03 17:42:24',NULL),
(6,4,28,'Diizinkan','2022-09-03 18:07:54',NULL),
(7,4,14,'Diizinkan','2022-09-03 18:08:21',NULL),
(8,5,28,'Diizinkan','2022-09-04 15:03:28',NULL),
(9,5,14,'Diizinkan','2022-09-04 15:03:44',NULL),
(10,5,5,'Diizinkan','2022-09-04 15:04:09',NULL);
