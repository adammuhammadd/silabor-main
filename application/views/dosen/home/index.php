	...
	<div class="container-fluid">
		<div class="card">
			<div class="card-header pb-0">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?= base_url() ?>dosen/home" data-bs-original-title="" title=""><i class="fa fa-home"></i></a></li>
						...
						<div class="card-body table-responsive p-0">
							...
							<div class="mt-3">
								<div class="mb-3 mb-lg-0 gap-3 d-flex align-items-center bg-danger flex-column flex-lg-row justify-content-between p-3">
									...
									<a href="<?= base_url('dosen/pinjam_alat/form_pinjam_alat/') . $peminjaman->row()->id_permohonan_pinjam_alat ?>" class="btn btn-light">Download Surat Disini !</a>
								</div>
							</div>
						</div>
