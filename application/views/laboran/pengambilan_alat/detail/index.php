					...
					<div class="card-body table-responsive p-0">
						...
						<div class="d-flex justify-content-end px-3 mt-3">
							<div class="d-flex gap-3">
								<button class="btn btn-primary btn-diambil" type="button" data-bs-toggle="modal" data-bs-target="#modal-diambil">Alat Telah Diambil</button>
							</div>
						</div>
					</div>
					...
					<div class="card mt-5">
						<div class="card-header">
							<div class="d-flex justify-content-between">
								<h5 class="left-0">Daftar Alat Yang Di Ajukan</h5>
							</div>
						</div>
...
<div class="modal fade" id="modal-diambil" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title">Konfirmasi Pengambilan Alat</h6>
				<button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close">
				</button>
			</div>
			<form id="form-index">
				<div class="modal-body grid-showcase">
					<div id="body-modal">Apakah anda yakin alat telah diambil ?</div>
				</div>
				<div class="notif mx-3"></div>
				<div class="modal-footer">
					<button class="btn btn-danger" type="button" data-bs-dismiss="modal">Tidak</button>
					<button class="btn btn-primary ya-diambil" type="button">Ya</button>
				</div>
			</form>
		</div>
	</div>
