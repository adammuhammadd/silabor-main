...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $get_fakultas_mahasiswa = $this->db->select('tb_user.*, tb_prodi.*, tb_fakultas.*')
            ->from('tb_user')
        ...
        $data = array(
            ...
            'get_fakultas_mahasiswa' => $get_fakultas_mahasiswa,
            'user' => $user->row(),
            'data' => $query,
            'page' => 'mahasiswa/home/index',
            'link' => 'mahasiswa/home',
            'script' => 'mahasiswa/home/script'
        );
